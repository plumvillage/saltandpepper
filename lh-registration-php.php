 ...
 *
 * Template Name:  LH Planyo PHP
 * @file           lh-registration-php.php
 * @package        SaltandPepper
 * @author         Emil Uzelac
 * @copyright      2003 - 2011 ThemeID
 * @license        license.txt
 * @version        Release: 1.0
 * @filesource     wp-content/themes/saltandpepper/lh-registration-php.php
 ...
 */
 ...
 <div id="content-full" class="grid col-940">
   ...
   $planyo_site_id = '12498';  // ID of your planyo site. It can be a number or 'demo' to see demonstration of the plugin
